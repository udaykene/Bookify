...
const AllRooms = () => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row item-start justify-between pt-28 md:pt35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
        ...
        {/* Filters */}
        <div className='bg-white w-80 border h-fit border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'> 
